#!/usr/bin/env python3
"""
CBSim Carnot Battery Multi-Objective Optimization - Position position2
...
def set_params():
    ...
    """
    # Fixed parameters for CBSim model - Position position2
...
def evaluate(x_in, params=[]):
    ...
    try:
        ...
        # Fixed parameters for position2 (from design_space.csv 'par' entries)
        T_hp_cs = design_vars.get('T_hp_cs', 40.0)      # Heat source temperature (°C)
        T_he_cs = design_vars.get('T_he_cs', 30.0)       # Heat sink temperature (°C)
...
if __name__ == "__main__":
    ...
    print("Testing CBSim multi-objective case description for position2...")

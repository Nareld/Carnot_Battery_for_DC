#!/usr/bin/env python3
"""
CBSim Carnot Battery Multi-Objective Optimization - Position position3
...
def set_params():
    ...
    """
    # Fixed parameters for CBSim model - Position position3
...
def evaluate(x_in, params=[]):
    ...
    try:
        ...
        # Fixed parameters for position3 (from design_space.csv 'par' entries)
        T_hp_cs = design_vars.get('T_hp_cs', 60.0)      # Heat source temperature (°C)
...
if __name__ == "__main__":
    ...
    print("Testing CBSim multi-objective case description for position3...")
